...
export const DEFAULT_ROLE_DEFINITIONS: DefaultRoleDefinition[] = [
  ...
  },
  {
    ...
    permissions: ['resume:all', 'resume:assign', 'customer:all', 'contract:all', 'insurance:all', 'background-check:all', 'user:view', 'admin:settings', 'evaluation:edit', 'evaluation:delete', 'blacklist:view', 'blacklist:create', 'blacklist:edit'],
    active: true,
  },
  {
    code: 'employee',
