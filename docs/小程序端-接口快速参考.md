...
| 接口 | 路径 | 方法 | 认证 | 用途 |
|------|------|------|------|------|
| 获取Banner列表 | `/api/banners/miniprogram/active` | GET | ❌ 无需 | 获取首页轮播图 |
...
获取小程序首页展示的轮播图Banner列表，按排序字段升序排列。
  ...
  "data": [
    {
      ...
      "title": "首页Banner",
      "imageUrl": "https://housekeeping-1254058915.cos.ap-guangzhou.myqcloud.com/xxx.jpg",
      "linkType": "none",
      "order": 0
    }
  ],
